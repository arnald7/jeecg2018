<?php
	...
	class Livros
	{
		...
		function listaLivros() // Lista os livros
		{
			...
			//	echo '<td>'. utf8_encode( $row['autor']  ) . '</td>';
				...
				echo '<td>'. ( $row['espirito']  ) . '</td>';
				echo '<td>'. ( $row['editora']  ) . '</td>';
				echo '<td>'. ( $row['edicao']  ) . '</td>';
				echo '<td>'. ( $row['isbn']  ) . '</td>';
				echo '<td>'. ( $row['quantidade']  ) . '</td>';
				echo '<td><button class="btn"><a href="editar.php?id='.($row['id']).'">Editar</a></button>&nbsp;&nbsp;<button class="btn"><a href="index.php?del_id='.($row['id']).'">Delete</a></button></td>';
				echo '</tr>';
			}
