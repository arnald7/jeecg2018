...
/*		function listarUserItensporData($idUser) // Lista os itens com o jobs ativos ordenados por data
		{
			$sql = "SELECT itens.*, jobs.ativo, jobs.job, usuarios.usuario, clientes.cliente \n"
			. "FROM itens\n"
